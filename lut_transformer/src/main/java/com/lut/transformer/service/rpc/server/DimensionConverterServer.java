package com.lut.transformer.service.rpc.server;
...
public class DimensionConverterServer {
	public static final String CONFIG_SAVE_PATH = "/zhcg/transformer/rpc/config";
	...
	public void startServer(){
		...
		synchronized (this) {
			...
			try {
				...
				//创建服务
				this.server = new RPC.Builder(conf).setInstance(converter).setProtocol(IDimensionConverter.class)
