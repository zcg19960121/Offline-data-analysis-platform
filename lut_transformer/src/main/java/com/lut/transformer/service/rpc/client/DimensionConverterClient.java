package com.lut.transformer.service.rpc.client;
...
import com.lut.transformer.service.rpc.server.DimensionConverterImpl;
import com.lut.transformer.service.rpc.server.DimensionConverterServer;
...
public class DimensionConverterClient {
	...
	private static class InnerDimensionConverterProxy implements IDimensionConverter{
		...
		private Map<String,Integer> cache = new LinkedHashMap<String,Integer>(){
			private static final long serialVersionUID = -3920806913452172393L;
            @Override
