...
-- 3. 上传lut_transformer-0.0.1-SNAPSHOT.jar到linux集群和hdfs集群上，然后启动DimensionConverterServer服务
-- 4. 创建function
create function currency_type_convert as 'com.lut.transformer.hive.CurrencyTypeDimensionUDF' using jar 'hdfs://hadoop-work:8020/zhcg/transformer/lut_transformer-0.0.1-SNAPSHOT.jar';
create function payment_type_convert as 'com.lut.transformer.hive.PaymentTypeDimensionUDF' using jar 'hdfs://hadoop-work:8020/zhcg/transformer/lut_transformer-0.0.1-SNAPSHOT.jar';
create function order_info as 'com.lut.transformer.hive.OrderInfoUDF' using jar 'hdfs://hadoop-work:8020/zhcg/transformer/lut_transformer-0.0.1-SNAPSHOT.jar';
create function order_total_amount as 'com.lut.transformer.hive.OrderTotalAmountUDF' using jar 'hdfs://hadoop-work:8020/zhcg/transformer/lut_transformer-0.0.1-SNAPSHOT.jar';
