...
-- 5. 上传transformer-0.0.1.jar到hdfs的/zhcg/transformer文件夹中

-- 6. 创建hive的function
create function platform_convert as 'com.lut.transformer.hive.PlatformDimensionUDF' using jar 'hdfs://hadoop-work:8020/zhcg/transformer/lut_transformer-0.0.1-SNAPSHOT.jar';  
create function date_convert as 'com.lut.transformer.hive.DateDimensionUDF' using jar 'hdfs://hadoop-work:8020/zhcg/transformer/lut_transformer-0.0.1-SNAPSHOT.jar';  
